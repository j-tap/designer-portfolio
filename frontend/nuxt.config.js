...
export default defineNuxtConfig({
	...
	app: {
		head: {
			...
			titleTemplate: '%s',
			link: [
				// Ранний коннект к медиа-серверу: картинки проектов грузятся с него
				{ rel: 'preconnect', href: strapi.publicUrl, crossorigin: '' },
				{ rel: 'dns-prefetch', href: strapi.publicUrl },
